    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_salary', models.IntegerField(blank=True, default=0, verbose_name='Ежемесячный оклад')),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_tool', models.CharField(blank=True, choices=[('PU', 'ПУ'), ('EVA', 'ЭВА')], max_length=40)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='manufacture.employee', verbose_name='ФИО сотрудника')),
            ],
        ),
        migrations.CreateModel(
